...
async function filesToAtlas(files, atlas2DContext, atlas_width, atlas_height, invisibleDiv, desiredWindowCenter, desiredWindowWidth) {
  ...
  return Promise.all(slicePromiseList);
